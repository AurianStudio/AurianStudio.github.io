...
(function() {
    ...
    function Wt(e) {
        ...
        if (e.params["offlabel-show-privacy"] !== void 0 && t.set("offlabel_show_privacy", String(e.params["offlabel-show-privacy"])),
    ...
    function Gr(e, t, a) {
        return t = Ae(t),
        jr(e, Qe() ? Reflect.construct(t, a || [], Ae(e).constructor) : t.apply(e, a))
    }
    function Xr(e, t) {
        if (!L(e, t))
    ...
    function et() {
        ...
        if (L(t, HTMLScriptElement) && e.test(t.src))
            return t;
        for (var a = document.querySelectorAll("script"), i = 0, o; o = a[i]; i++)
            if (L(o, HTMLScriptElement) && e.test(o.src))
                return o
    }
    function $r() {
        var e = et();
    ...
    function oa(e) {
        ...
        try {
            for (var s = Object.getOwnPropertySymbols(e)[Symbol.iterator](), d; !(i = (d = s.next()).done); i = !0) {
                var p = d.value, f, v = ea((f = Object.getOwnPropertyDescriptor(e, p)) === null || f === void 0 ? void 0 : f.value);
                if (v)
                    return v
            }
        } catch (E) {
    ...
    var Gt = function(t, a, i, o, u) {
        var s, d, p = na(t), f = _t(a.params, !1, o), v = "h/".concat("b", "/"), E = en("".concat(f, "/cdn-cgi/challenge-platform/").concat(v, "feedback-reports/").concat(Ze(t), "/").concat(a.displayLanguage, "/").concat((d = a.params.theme) !== null && d !== void 0 ? d : a.theme, "/").concat(i));
        if (Ue(a),
    ...
    function _a(e, t, a, i) {
        for (var o = "", u = an(e) ? ga(e, i) : void 0, s = document.createNodeIterator(e, NodeFilter.SHOW_ELEMENT | NodeFilter.SHOW_TEXT), d; (d = s.nextNode()) !== null && o.length < a; )
            if (!ya(d, u)) {
    ...
    function Ra(e, t, a) {
        ...
        t.apiJsReloadBackoffMs = d ? Le : fn(s),
    ...
    function Ua(e, t) {
        var a, i = (a = e.params["response-field"]) !== null && a !== void 0 ? a : !0, o = m.isRecaptchaCompatibilityMode, u = "".concat(t, "_response"), s = "".concat(t, "_g_response"), d = (!i || L(document.getElementById(u), HTMLInputElement)) && (!o || L(document.getElementById(s), HTMLInputElement));
    ...
    function Wa(e, t, a) {
        ...
        if (i !== null && L(i, HTMLInputElement) && (i.value = a),
    ...
    function Rt(e, t, a) {
        return e === null ? t : Aa(e) ? e === "true" : (x(a(e)),
        t)
    }
    function Nn() {
        try {
            ...
            try {
                for (var u = performance.getEntriesByType("resource")[Symbol.iterator](), s; !(a = (s = u.next()).done); a = !0) {
                    var d = s.value;
                    if (L(d, PerformanceResourceTiming) && d.name.includes(t))
                        return d
                }
            } catch (p) {
                i = !0,
        ...
        var e = function(n, l, r, c, b, g) {
          ...
          , A = function(n, l) {
            ...
            if (c) {
                ...
                (c.params.appearance === me.InteractionOnly || c.params.appearance === me.Execute) && Pa(w),
                ...
                Na(P, c),
                c.iframeOrigin = De(W),
                (g = w.parentNode) === null || g === void 0 || g.replaceChild(P, w),
                dr(c, O),
          ...
          , N = function(n, l, r) {
            var c, b, g, k, O, w, P, W, ae, ne, ce, te, re, Ce = $(), J, se;
            if (typeof n == "string") {
                var de = wt(n);
                if (de) {
                ...
                L(n, HTMLElement) ? J = n : h('Invalid type for parameter "container", expected "string" or an implementation of "HTMLElement"', 3587);
            if (!se) {
                var Ee = wt(J);
                if (Ee) {
            ...
            if (ut) {
                ...
                y["retry-interval"] = Number((O = y["retry-interval"]) !== null && O !== void 0 ? O : Ur),
                y["expiry-interval"] = Number((w = y["expiry-interval"]) !== null && w !== void 0 ? w : (Ar - Sr) * 1e3),
                y.size = (P = y.size) !== null && P !== void 0 ? P : Y.Normal;
                var ct = y.callback
                ...
                Ta(ie) || h('Invalid input for parameter "sitekey", got "'.concat(ie, '"'), 3589),
                ...
                if (!(!ze || !st)) {
                    ...
                    Re.iframeOrigin = De(_r),
                    X.setAttribute("src", _r),
                    Na(X, Re);
                    var br = ["cross-origin-isolated", "fullscreen", "autoplay", "keyboard-map", "gamepad", "xr-spatial-tracking"];
                    return q((ne = (re = document.featurePolicy) === null || re === void 0 || (te = re.features) === null || te === void 0 ? void 0 : te.call(re)) !== null && ne !== void 0 ? ne : [], Bt) && br.push(Bt),
                    X.setAttribute("allow", br.join("; ")),
          ...
          , ge = function() {
            var n = [Mr, Nr];
            m.isRecaptchaCompatibilityMode && n.push(Pr),
                    ...
                    case "init":
                        {
                            ...
                            r.params.appearance === me.Always || r.isExecuting && r.params.appearance === me.Execute ? It(c, r) : Pa(c),
                            c.style.display = "";
                            var b = Oe(r, l);
                    ...
                    case "fail":
                        {
                            ...
                            if (ce) {
                                var J;
                                ce(String((J = n.code) !== null && J !== void 0 ? J : Cr)) ? re && r.params.retry === yt.Auto && !r.isResetting && t(r, l, te) : (n.code && x("Error: ".concat(n.code, ".")),
                                re && t(r, l, te))
                            } else
                                n.code ? (re && t(r, l, te),
    ...
    kt = nt && Se ? Ra(window.turnstile, m, function() {
        var e;
        window.turnstile = Tt,
    ...
    Se || ((B == null || (Ot = B.params) === null || Ot === void 0 ? void 0 : Ot.get("render")) !== "explicit" && gr.push(Pn),
