// --- inline from page 45 ---
				...
				var digitalData = {"events": {"pageView": true, "productPageView": false}, "site": {"brand": "cibcus","name": "sb","type": "responsive","environment": "production","appVersion": "6.3.1","lastBuildDate": "2025-10-16"},"page": {"name": "financing-solutions","url": "https://us.cibc.com/en/small-business/financing-solutions.html","referrer": "","hierarchy": [],"language": "English","accessibility": true},"user": {"authState": "not-authenticated"}}
...
// --- inline from page 45 ---
!function(a){var e="https://s.go-mpulse.net/boomerang/",t="addEventListener";if("True"=="True")a.BOOMR_config=a.BOOMR_config||{},a.BOOMR_config.PageParams=a.BOOMR_config.PageParams||{},a.BOOMR_config.PageParams.pci=!0,e="https://s2.go-mpulse.net/boomerang/";if(window.BOOMR_API_key="9R2KU-8SGEY-TQLMP-RK4SR-2377J",function(){function n(e){a.BOOMR_onload=e&&e.timeStamp||(new Date).getTime()}if(!a.BOOMR||!a.BOOMR.version&&!a.BOOMR.snippetExecuted){a.BOOMR=a.BOOMR||{},a.BOOMR.snippetExecuted=!0;var i,_,o,r=document.createElement("iframe");if(a[t])a[t]("load",n,!1);else if(a.attachEvent)a.attachEvent("onload",n);r.src="javascript:void(0)",r.title="",r.role="presentation",(r.frameElement||r).style.cssText="width:0;height:0;border:0;display:none;",o=document.getElementsByTagName("script")[0],o.parentNode.insertBefore(r,o);try{_=r.contentWindow.document}catch(O){i=document.domain,r.src="javascript:var d=document.open();d.domain='"+i+"';void(0);",_=r.contentWindow.document}_.open()._l=function(){var a=this.createElement("script");if(i)this.domain=i;a.id="boomr-if-as",a.src=e+"9R2KU-8SGEY-TQLMP-RK4SR-2377J",BOOMR_lstart=(new Date).getTime(),this.body.appendChild(a)},_.write("<bo"+'dy onload="document._l();">'),_.close()}}(),"300".length>0)if(a&&"performance"in a&&a.performance&&"function"==typeof a.performance.setResourceTimingBufferSize)a.performance.setResourceTimingBufferSize(300);!function(){if(BOOMR=a.BOOMR||{},BOOMR.plugins=BOOMR.plugins||{},!BOOMR.plugins.AK){var e=""=="true"?1:0,t="",n="z7ggohyx3maki2r7eiyq-f-40d87475f-clientnsv4-s.akamaihd.net",i="false"=="true"?2:1,_={"ak.v":"41","ak.cp":"683729","ak.ai":parseInt("447968",10),"ak.ol":"0","ak.cr":41,"ak.ipv":4,"ak.proto":"h2","ak.rid":"12155b3b","ak.r":41749,"ak.a2":e,"ak.m":"dscx","ak.n":"essl","ak.cport":38409,"ak.gh":"23.218.251.36","ak.quicv":"","ak.tlsv":"tls1.3","ak.0rtt":"","ak.0rtt.ed":"","ak.csrc":"-","ak.acc":"","ak.t":"1782522417","ak.ak":"hOBiQwZUYzCg5VSAfCLimQ==","ak.pv":"52","ak.dpoabenc":"","ak.tf":i};if(""!==t)_["ak.ruds"]=t;var o={i:!1,av:function(e){var t="http.initiator";if(e&&(!e[t]||"spa_hard"===e[t]))_["ak.feo"]=void 0!==a.aFeoApplied?1:0,BOOMR.addVar(_)},rv:function(){var a=["ak.cport","ak.cr","ak.csrc","ak.gh","ak.ipv","ak.m","ak.n","ak.ol","ak.proto","ak.quicv","ak.tlsv","ak.0rtt","ak.0rtt.ed","ak.r","ak.acc","ak.t","ak.tf"];BOOMR.removeVar(a)}};BOOMR.plugins.AK={akVars:_,akDNSPreFetchDomain:n,init:function(){if(!o.i){var a=BOOMR.subscribe;a("before_beacon",o.av,null,null),a("onbeacon",o.rv,null,null),o.i=!0}return this},is_complete:function(){return!0}}}}()}(window);
...
// --- inline from page 45 ---
    ...
    function validateField1() {
        ...
        error = false;
        hideError('Field1-err1');
        hideError('Field1-err2');
        if (document.contactForm.Field1.value == '') {
            displayErrMsg('Field1-err1');
        } else if (!re.test(document.contactForm.Field1.value)) {
    ...
    function validateField2() {
        re = /^(?:(?:\+?1\s*(?:[.-]\s*)?)?(?:\(\s*([2-9]1[02-9]|[2-9][02-8]1|[2-9][02-8][02-9])\s*\)|([2-9]1[02-9]|[2-9][02-8]1|[2-9][02-8][02-9]))\s*(?:[.-]\s*)?)?([2-9]1[02-9]|[2-9][02-9]1|[2-9][02-9]{2})\s*(?:[.-]\s*)?([0-9]{4})(?:\s*\s*(\d+))?$/;
        error = false;
        hideError('Field2-err1');
        hideError('Field2-err2');
        if (document.contactForm.Field2.value == '') {
            displayErrMsg('Field2-err1');
        } else if (!re.test(document.contactForm.Field2.value)) {
    ...
    function validateField3() {
        ...
        error = false;
        hideError('Field3-err1');
        hideError('Field3-err2');
        if (document.contactForm.Field3.value == '') {
            displayErrMsg('Field3-err1');
        } else if (!re.test(document.contactForm.Field3.value)) {
    ...
    //Zip Code
    function validateField4() {
        re = /^[a-zA-Z0-0!@#\$%\^\&*\)\(+=._-]+$/;
        lengthMax = /^\d{5}?$/;
        error = false;
        hideError('Field4-err1');
        hideError('Field4-err2')
        hideError('Field4-err3');
        if (document.contactForm.Field4.value == '') {
            displayErrMsg('Field4-err1');
        } else if (re.test(document.contactForm.Field4.value)) {
            displayErrMsg('Field4-err2');
        } else if (!lengthMax.test(document.contactForm.Field4.value)) {
            displayErrMsg('Field4-err3');
        } else {
            $("#Field4-err1").hide();
            $("#Field4-err2").hide();
            $("#Field4-err3").hide();
    ...
    $(document).ready(function () {
        $("#contactFormSubmitButton").click(function (event) {
            error1 = validateField1();
            error2 = validateField2();
            error3 = validateField3();
            error4 = validateField4();
            var error = error1 || error2 || error3 || error4;
            if (!error) {
                var language = (window.location.href.indexOf('/fr/') > -1) ? "-fr" : "";
                var requestData = $('#share-form').serializeObject();
                var confirmationPage = requestData.form.collectedData.confirmPage;
                $.ajax({
                    url: 'https://www.cibconline.cibc.com/ebm-forms/api/v2/json/forms',
                    async: true,
                    cache: false,
                    type: 'POST',
                    dataType: 'json',
                    ...
                    success: function () {
                        window.location = 'https://us.cibc.com' + confirmationPage;
                    },
                    error: function () {
                        window.location = "https://us.cibc.com/en/error.html";
                    }
                });
            }
        });
...
function analyticsOTDeleteCookie() {
    if(_satellite.cookie.get('cleared-onetrust-cookies') === undefined) {
      ...
      if(_satellite.cookie.get('OptanonAlertBoxClosed') !== undefined && _satellite.cookie.get('OptanonAlertBoxClosed') !== ''){
        _satellite.cookie.remove('OptanonAlertBoxClosed', { 'path': '/', 'domain': '.us.cibc.com' });
      }
      
      if(_satellite.cookie.get('OptanonConsent') !== undefined && _satellite.cookie.get('OptanonConsent') !== ''){
        _satellite.cookie.remove('OptanonConsent', { 'path': '/', 'domain': '.us.cibc.com' });
      }      
...
function addEventListener(){null!=_satellite.cookie.get("OptanonConsent")&&_satellite.cookie.get("OptanonConsent").indexOf("C0001:1")>-1?_satellite.track("trigger"):(_satellite.logger.log("Awaiting Consent To Be Updated"),setTimeout(addEventListener,100))}_satellite.getVar("ot_in_scope_flag")?addEventListener():_satellite.track("trigger");
});
